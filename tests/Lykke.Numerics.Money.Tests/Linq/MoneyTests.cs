...
namespace Lykke.Linq
{
    ...
    public class MoneyTests
    {
        ...
        {
            Action action = () => ObjectsWithValues().Average(null);
        ...
        {
            Action action = () => ObjectsWithNullableValues().Average(null);
        ...
        {
            Action action = () => ObjectsWithValues().Max(null);
        ...
        {
            Action action = () => ObjectsWithNullableValues().Max(null);
        ...
        {
            Action action = () => ObjectsWithValues().Min(null);
        ...
        {
            Action action = () => ObjectsWithNullableValues().Min(null);
        ...
        {
            Action action = () => ObjectsWithValues().Sum(null);
        ...
        {
            Action action = () => ObjectsWithNullableValues().Sum(null);
