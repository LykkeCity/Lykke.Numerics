...
namespace Lykke.Numerics
{
    public partial struct Money
    {
            ...
            Money right)
        {
            ...
            return new Money(sumSignificand, sumScale);
        }
            ...
            Money value)
        {
            ...
            return new Money(significand, value._scale);
        }
        ...
        {   
            ...
            return new Money(quotientSignificand, quotientScale);
        }
            ...
            Money right)
        {
            ...
            return new Money(productSignificand, productScale);
        }
        ...
        public static Money Negate(
            Money value)
        {
            return new Money(-value._significand, value._scale);
        }
            ...
            Money right)
        {
            ...
            return new Money(diffSignificand, diffScale);
        }
