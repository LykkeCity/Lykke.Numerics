...
namespace System.Numerics.Tests
{
    ...
    public class ArithmeticTests
    {
        ...
        {
            Action divisionByZero = () => BigDecimal.Divide(1, 0);
        ...
        {
            var dbg = (int) (BigInteger) (new BigDecimal(0));
            
            BigDecimal
                .Negate(BigDecimal.Parse(a))
                .Should()
                .Be(b);
        }
        ...
        public void Round__All_MidpointRounding_Modes_Are_Supported()
        {
            ...
            {
                Action round = () => BigDecimal.Round(0.5m, mode);
        ...
        {
            BigDecimal
                .Truncate(BigDecimal.Parse(a))
                .Should()
                .Be(b);
        }
        
        private static (BigDecimal Left, BigDecimal Right) Parse(string left, string right)
        {
